...
khi trang web được tải file main.js được thực thi , javaScript chạy câu lệnh"console.log("Hello from JavaScript!");"và in nội dung ra console
---
...
> - CSS: thiết kế giao diện và định dạng hiển thị
> - JavaScript:xử lí hành vi và tương tác của trang web
...
Hello from JavaScript! Xin chào, mình là Ngân, năm nay mình 20 tuổi.

> - Nếu em quên dấu `;` hoặc quên dấu `+`, điều gì xảy ra? Trình duyệt báo lỗi thế nào?
khi quên dấu ';' trình duyệt vẫn chạy bình thường, quên dấu '+ 'trình duyệt báo lỗi
Uncaught SyntaxError: missing ) after argument list (at main.js:6:36)
...
Điều thú vị nhất em khám phá được là Console cho phép chạy và kiểm tra JavaScript trực tiếp mà không cần sửa file HTML hay JS.
Em có thể:Khai báo biến,Tính toán,Kiểm tra kiểu dữ liệu bằng typeof,Thử nghiệm code ngay lập tức
Console giống như một môi trường thử nghiệm nhanh giúp em hiểu cách JavaScript hoạt động khi trang web được tải.
> - Em gặp lỗi cú pháp nào? Em đã xử lý bằng cách nào (tự sửa, hỏi bạn, đọc lỗi, tìm Google, …)?
Em gặp lỗi cú pháp khi vô tình sao chép cả dấu js và vào file main.js, khiến trình duyệt báo lỗi:
Uncaught TypeError: "" is not a function
Em đã xử lý bằng cách:
Đọc kỹ thông báo lỗi trong Console
Kiểm tra lại dòng đầu của file JS
Xóa các ký tự không hợp lệ
Lưu lại file và reload trang
---
...
nếu điều kiện đúng thì thực hiện if, nếu điều kiện sai thì thực hiện else
...
giúp giảm lặp code
làm chương trình ngắn gọn, dễ đọc
dễ bảo trì và sửa lỗi
có thể tái sử dụng nhiều lần
giúp chương trình có cấu trúc dễ dàng hơn
...
Cách điều kiện trong if được đánh giá là true hoặc false và cách hoạt động của return trong hàm (khi  gặp return thì hàm dừng lại ngay)
> - Em đã làm gì để vượt qua (thử nhiều lần, hỏi bạn, xem lại ví dụ, tra Google, …)?
Thử chạy từng đoạn code nhỏ trong Console
Sửa đi sửa lại nhiều lần để quan sát kết quả
Đọc kỹ thông báo lỗi trong Console
Xem lại ví dụ mẫu
Tìm kiếm trên Google khi gặp lỗi lạ
...
tìm và lấy phần tử html có id="status trong trang web
> - Sự kiện `"click"` xảy ra khi nào?
người dùng nhấn chuột vào phần tử
> - Trong đoạn code trên, khi nhấn nút `btnHello`, điều gì thay đổi trên trang? trang hiển thị dòng chữ
...
input xảy ra khi giá trị của ô input thay đổi còn click xảy ra khi nhấp chuột vào phần tử
...
>   DOM là cách mà trình duyệt biến toàn bộ trang HTML thành một cấu trúc dạng cây, trong đó mỗi thẻ (như html, body, div, p, button…) đều trở thành một đối tượng (object)
